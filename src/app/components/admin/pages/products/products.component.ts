  ...
  ProductData: any;
    ...
    getProducts() {
      this.productService.getDataProducts().subscribe((res: any) => {
        ...
        console.log('Products dataset', this.dataset);
      });
    }
...
onActiveCellChanged(e: any) {
  ...
  const dataContext = this.angularGrid?.gridService?.getDataItemByRowIndex(row) 
...
onSelectedRowsChanged(e: any) {
  ...
  const item = this.angularGrid?.gridService?.getDataItemByRowIndex(rowIndex) 
